            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <div class="footer__about">
                    <div class="footer__social">
                        <a href="https://www.instagram.com/abevents_250/"><button type="button" class="btn btn-info rounded-circle  btn-sm"><i class="fa fa-instagram"></i></button></a>
...
<script type="text/javascript">
    var scrolltotop = {
        ...
        controlHTML: '<img src="img/top.png" style="width:40px;" />',
        controlattrs: {
            offsetx: 40,
            offsety: 40
        },
        ...
        togglecontrol: function() {
            ...
            this.cssfixedsupport || this.keepfixed(), this.state.shouldvisible = t >= this.setting.startline ? !0 : !1, this.state.shouldvisible && !this.state.isvisible ?
