...
if (isset($_POST['process_rents'])) {
    ...
    $paid_money = mysqli_real_escape_string($connection, $_POST['rent_paidMoney']);
    ...
    if (is_array($m_name)) {
        ...
        $credit_money = $transaction_allday_price - $paid_money;
    ...
    '$transaction_allday_price','booked_sale','$paid_money','$credit_money','Not Returned','$proof_image','$payment',NOW())");
        if ($sql2 !== TRUE) {
            // If the insert fails, set the success status to false
            $insertSuccess = false;
            $sql2Success = false;
    ...
    if ($insertSuccess) {
        if ($notify == 'on') {
            $data = array(
                ...
                "message" => "Hello! B_ID: $rents_id, Cost: $transaction_allday_price Rwf, Credit:$credit_money Rwf, Rent:$rent_date, Return:$return_date, Book Us: 0783236256 | www.abeventsgroup.com",
                "dlrurl" => ""
            );
...
<head>
    ...
    <title>Booked Sale | AB Events | an exceptional experience</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Booked Sale</h1>
                            ...
                            <div class="ibox-body">
                                <form action="" method="POST" id="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group">
                                            <label>Paid Money <b class="required">*</b></label>
                                            <input class="form-control" type="text" value="0" name="rent_paidMoney" required placeholder="Provide Booking Paid money">
                                        </div>
