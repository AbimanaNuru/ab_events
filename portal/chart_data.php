...
?>
    ...
    $sqlQuery = "SELECT rent_transaction_rent_date,sum(rent_transaction_total_price) as price FROM  ab_events_rent_transaction group by rent_transaction_rent_date ";
