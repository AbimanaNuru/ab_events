...
<head>
    ...
    <title>Report [ <?php echo $start_date; ?> - <?php echo $end_date; ?> ] | AB Events | an exceptional experience</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="period_reporting.php?report_by=1 MONTH">
                        ...
                        <div class="ibox bg-info color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong">
                                    <?php
                                    $query = "SELECT SUM(rent_transaction_total_price) AS total_price FROM ab_events_rent_transaction WHERE rent_transaction_rent_date BETWEEN '$start_date' AND '$end_date'";
...
WHERE ab_events_rent_transaction.rent_transaction_clients_id =  ab_events_clients.client_id AND ab_events_rent_transaction.rent_transaction_rent_date BETWEEN '$start_date' AND '$end_date'");
                                    ...
                                    <table id="example2" class="table is-striped responsive nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $result = mysqli_query($connection, "SELECT * FROM ab_events_expense,ab_users WHERE ab_users.ab_user_id = ab_events_expense.expense_added_by
                                             AND ab_events_expense.ab_events_expense_done_data  BETWEEN '$start_date' AND '$end_date' ");
                                    ...
                                    <table id="example3" class="table is-striped responsive nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $result = mysqli_query($connection, "SELECT * FROM ab_events_clients,ab_users WHERE ab_users.ab_user_id = ab_events_clients.ab_events_added_by
                                             AND ab_events_clients.client_joining_date BETWEEN '$start_date' AND '$end_date'");
